            ...
            <div>
              ...
              <div className="-space-y-4">
                <article className="pl-4 relative">
                  ...
                  <h4 className="text-[48px] tracking-[0.02em] font-['EnfiladeTRIALHeadline-Bold'] text-white/80 uppercase relative">
                    THE RISE OF RECESSION CORE
                  </h4>
                </article>
                <article className="pl-4">
                  <h4 className="text-[48px] tracking-[0.02em] font-['EnfiladeTRIALHeadline-Bold'] text-white/80 uppercase">
