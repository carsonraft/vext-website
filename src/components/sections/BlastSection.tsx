            ...
            <div>
              ...
              <div className="-space-y-4">
                <article className="pl-4 relative">
                  ...
                  <h4 className="text-[48px] font-semibold font-enfilade text-white uppercase relative leading-[110%]">
                    The Rise of Recession Core
                  </h4>
                </article>
                <article className="pl-4">
                  <h4 className="text-[48px] font-semibold font-enfilade text-white uppercase leading-[110%]">
                    The Coquette Effect
                  </h4>
                </article>
                <article className="pl-4">
