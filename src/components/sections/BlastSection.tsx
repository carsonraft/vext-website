          ...
          <div className="space-y-8 pl-8">
            <div>
              <div className="relative inline-block">
                <h3 className="inline-block px-4 py-1 rounded-full border-[0.25px] border-white text-[24px] font-bold mb-4 font-['EnfiladeTRIALHeadline-Bold'] text-white relative z-10">
                  VEXT BLAST
                </h3>
              </div>
