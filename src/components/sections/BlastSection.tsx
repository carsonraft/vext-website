        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative w-3/4">
              <div className="absolute inset-0 border border-[#C6FF00]/20 bg-[#04120B]/10 transform translate-x-[10%] translate-y-[2%] -z-10" />
              <div className="absolute inset-0 border border-[#C6FF00]/80 bg-[#04120B]/30 transform translate-x-[5%] -translate-y-[10%]" />
              <img
                loading="lazy"
