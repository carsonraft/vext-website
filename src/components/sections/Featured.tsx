      ...
      <div className="w-full">
        <div className="album-cover relative">
          ...
          <div className="absolute bottom-0 left-0 p-8 w-full bg-gradient-to-t from-black to-transparent text-left">
            <div>
              <h2 className="text-white text-[48px] uppercase leading-[52.8px] tracking-[0.02em] font-['EnfiladeTRIALHeadline-Bold'] break-words mb-4">
                <Link to="/article" className="hover:text-[#C6FF00] transition-colors">JPEGMAFIA</Link>: TO SERVE & PROTECT
              </h2>
